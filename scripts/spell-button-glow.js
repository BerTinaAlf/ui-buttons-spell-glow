const SPELL_BUTTON_SELECTOR = [
  "button:not(#heartbeat-button):not(#hotbar button):not(#bg3-hotbar-container button):not(.dnd5e2.sheet.actor button:is(.inspiration, .death-save, .pip)):not(.radio-button)",
  ".button",
  ".control-tool",
  ".scene-control",
  ".playlist-control",
